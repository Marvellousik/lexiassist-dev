          ...
          <Card className="h-full">
            ...
            <CardContent className="p-3 sm:p-4">
              <textarea
                ...
                className="w-full h-64 sm:h-96 p-3 sm:p-4 text-sm text-slate-700 bg-slate-50 rounded-xl border border-slate-200 focus:border-[#4A8B5C] focus:ring-2 focus:ring-[#4A8B5C]/20 focus:outline-none resize-none"
              />
